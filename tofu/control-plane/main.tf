...
resource "cloudflare_workers_script" "scheduled_teardown" {
  ...
  plain_text_binding {
    ...
    text = "15 21 * * *"  # Notification at 20:45 UTC (21:45 CET)
  }

  plain_text_binding {
    name = "TEARDOWN_CRON"
    text = "15 21 * * *"  # Teardown at 21:00 UTC (22:00 CET)
  }
...
resource "cloudflare_workers_cron_trigger" "scheduled_teardown" {
  ...
  schedules   = [
    "15 21 * * *",  # Notification at 20:45 UTC (21:45 CET)
    "15 21 * * *",   # Teardown at 21:00 UTC (22:00 CET)
  ]
}
...
resource "cloudflare_record" "control_plane" {
  ...
  name    = "control-gabriel-vondercrone"
...
resource "cloudflare_pages_domain" "control_plane" {
  ...
  domain       = "control-gabriel-vondercrone.nona.company"
...
resource "cloudflare_zero_trust_access_application" "control_plane" {
  ...
  cors_headers {
    allowed_origins   = ["https://control-gabriel-vondercrone.nona.company"]
